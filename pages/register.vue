  ...
  <div class="container pt-5">
    <div class="row">
        <div class="col-lg-8 d-none d-lg-block">
            ...
            <p class="lead">Inscrivez-vous et bénéficiez de toutes les fonctionnalités que vous offre {{ APP_NAME }} </p>
            <img src="/img/signup.png" alt="Illustrator Inscription" class=" w-75">
        </div>
