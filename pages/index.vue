        ...
        <div class="hero-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div>
                            <img src="/home/assets/book-mockup.png" alt="Ebook" class="img-fluid book-mockup">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="overview">
        ...
        <div class="read-in-all">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <img src="/home/assets/devices-mockup.png" alt="mobile tablet devices"
        ...
        <div class="container">
            ...
            <div class="reviews-lists">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="review-list">
                            <img src="/home/assets/reader-2.jpg" alt="">
                            <h4>Michel Smith</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="review-list">
                            <img src="/home/assets/reader-3.jpg" alt="">
                            <h4>Root Stark</h4>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 author-details">
                    <img src="/img/logos/logo-congo-book.png" class="author-picture img-fluid" alt="">
                ...
                <div class="col-lg-7">
                    ...
                    <img src="/home/assets/signature.png" alt="Author Signature" class="autor-signature">
                </div>
            </div>
        </div>
    </section>
